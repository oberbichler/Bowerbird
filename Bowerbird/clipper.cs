...
namespace ClipperLib
{
  ...
  using cInt = Int32;
    ...
    internal struct Int128
    {
        ...
        public Int128(cInt _hi, UInt64 _lo)
        {
            lo = _lo;
            hi = _hi;
        }
        ...
        public static Int128 Int128Mul(cInt lhs, cInt rhs)
        {
