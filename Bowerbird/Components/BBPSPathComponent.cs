...
{
    public class BBPSPathComponent : GH_Component
    {
        public BBPSPathComponent() : base("BB Principal Stress Path", "PS", "Beta! Interface might change!", "Bowerbird", "Paths")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var path = PSPath.Create(refSurface.ToNurbsSurface(), actSurface.ToNurbsSurface(), youngsModulus, poissonsRatio, thickness, direction);
        ...
        public override Guid ComponentGuid => new Guid("{DB749B80-796A-4C9A-BF11-6E3830093D03}");
    }
}