...
namespace Bowerbird.Components
{
    public class BBLayerComponent : GH_Component
    {
        ...
        protected override System.Drawing.Bitmap Icon { get; } = Properties.Resources.icon_layer;

        public override Guid ComponentGuid { get; } = new Guid("{40C0EE3D-E7F9-4B18-97D6-802B99A910D4}");
    }
}
