...
namespace Bowerbird.Components.CraftingComponents
{
    public class BBSectionComponent : GH_Component
    {
        ...
        protected override System.Drawing.Bitmap Icon { get; } = Properties.Resources.icon_section;

        public override Guid ComponentGuid { get; } = new Guid("{63013336-F9FB-4902-B63C-6B13C8A2F2DA}");
    }
}
