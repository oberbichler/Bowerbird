...
namespace Bowerbird.Components.CraftingComponents
{
    public class BBIntersectionComponent : GH_Component
    {
        ...
        protected override System.Drawing.Bitmap Icon { get; } = Properties.Resources.icon_intersection;

        public override GH_Exposure Exposure { get; } = GH_Exposure.secondary;

        public override Guid ComponentGuid { get; } = new Guid("{DB9100DA-9996-4EE1-A955-399663EB9216}");
    }
}
