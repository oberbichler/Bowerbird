...
{
    public GeodesicCurvatureComponent() 
        : base("BB Geodesic Curvature CurveOnSurface", "κg", "Evaluate the geodesic curvature of an embedded curve at a specified parameter.", "Bowerbird", "Curve on Surface")
    {
    }
    ...
    protected override System.Drawing.Bitmap? Icon => Bowerbird.Properties.Resources.icon_curve_on_surface_geodesic_curvature;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public override Guid ComponentGuid => new("{A53C84BC-3697-4C2C-A590-BBE816A3527F}");
}
