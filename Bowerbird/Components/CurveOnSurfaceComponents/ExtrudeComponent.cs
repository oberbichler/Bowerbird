...
public class ExtrudeComponent : GH_Component
{
    public ExtrudeComponent() 
        : base("BB Extrude CurveOnSurface", "Extrude", "Extrude an embedded curve in direction of its normal vector.", "Bowerbird", "Curve on Surface")
    {
        Smooth = true;
    }
    ...
    {
        pManager.AddParameter(new CurveOnSurfaceParameter(), "Curve on Surface", "C", "Embedded curve to extrude", GH_ParamAccess.item);
    ...
    {
        GHUtility.SetMenuToggle(this, menu, "Smooth", () => Smooth, o => Smooth = o);
        GHUtility.SetMenuToggle(this, menu, "Unroll", () => Unroll, o => Unroll = o);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        else
        {
            ...
            if (Unroll && polyline.PointCount > 1)
            {
                ...
                for (int i = 1; i < polyline.PointCount; i++)
                {
                    var tDist = points3d[i] - points3d[i - 1];
                    ...
                    var oldPlane = new Plane(p, tDist, n);
    ...
    protected override System.Drawing.Bitmap? Icon => Bowerbird.Properties.Resources.icon_curve_on_surface_extrude;

    public override GH_Exposure Exposure => GH_Exposure.tertiary;

    public override Guid ComponentGuid => new("{860BD3B6-41C7-4B72-8E6B-C9F1E602238E}");
}
