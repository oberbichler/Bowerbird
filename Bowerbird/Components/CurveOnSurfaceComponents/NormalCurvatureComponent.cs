...
{
    public NormalCurvatureComponent() 
        : base("BB Normal Curvature CurveOnSurface", "κn", "Evaluate the normal curvature of an embedded curve at a specified parameter.", "Bowerbird", "Curve on Surface")
    {
    }
    ...
    protected override System.Drawing.Bitmap? Icon => Bowerbird.Properties.Resources.icon_curve_on_surface_normal_curvature;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public override Guid ComponentGuid => new("{ED838E93-41CC-4BDB-AACA-F8D3F948AB5E}");
}
