...
public class EvaluateComponent : GH_Component
{
    public EvaluateComponent() 
        : base("BB Evaluate CurveOnSurface", "BBEval", "Evaluate an embedded curve at a specified parameter.", "Bowerbird", "Curve on Surface")
    {
    }
    ...
    protected override System.Drawing.Bitmap? Icon => Bowerbird.Properties.Resources.icon_curve_on_surface_evaluate;

    public override GH_Exposure Exposure => GH_Exposure.secondary;

    public override Guid ComponentGuid => new("{B5702539-C9E3-4EFB-9DEF-445515F304D7}");
}
