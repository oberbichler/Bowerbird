...
namespace Bowerbird.Components.PathfinderComponents
{
    ...
    {
        public ConstructDGridPath() : base("BB DGrid Path", "DGrid", "Beta! Interface might change!", "Bowerbird", "Paths")
        {
        }
        ...
        public override Guid ComponentGuid { get; } = new Guid("{FD063786-F798-485D-8A53-97DE6B890327}");
    }
}